    ...
    */
    ...
    public function saveShopping1($data){
        ...
        for ($i=0; $i <count($data['idProducto']) ; $i++) {
			...
			$this->db->query("INSERT INTO compra VALUES(null,'" . $orden . "','" . $data['idProducto'][$i] . "','" . $data['cantidad'][$i] . "','" . $data['diaEntrega'] . "','" . $data['horaEntrega'] . "','" . $data['hourEntregaSpecial'] . "','" . $data['cliente'] . "','" . $data['telefono'] . "','" . $data['personaEntregar'] . "','" . $data['telefonoPersonaEntrega'] . "','" . $data['nota'] . "','" . $data['direccion'] . "','0','" . $data['geolocalizacion'] . "','" . $data['descripcionDomicilio'] . "','domicilio','0','0','0','" . $data['fecha_registro'] . "','" . $data['confirmacionDomicilio'] . "','" . $data['detalleExteriorDomicilio'] . "','0','" . $data['file'] ."')");

        }

		$this->db->query("INSERT INTO compra VALUES(null,'" . $orden . "','" . $dni . "','" . $cantidad . "','" . $data['diaEntrega'] . "','" . $data['horaEntrega'] . "','" . $data['hourEntregaSpecial'] . "','" . $data['cliente'] . "','" . $data['telefono'] . "','" . $data['personaEntregar'] . "','" . $data['telefonoPersonaEntrega'] . "','" . $data['nota'] . "','" . $data['direccion'] . "','" . $data['costoEnvio'] . "','" . $data['geolocalizacion'] . "','" . $data['descripcionDomicilio'] . "','domicilio','0','0','0','" . $data['fecha_registro'] . "','" . $data['confirmacionDomicilio'] . "','" . $data['detalleExteriorDomicilio'] . "','0','" . $data['file'] ."')");
    ...
    public function saveShopping2($data){
        ...
        for ($i=0; $i <count($data['idProducto']) ; $i++) { 
            ...
            $this->db->query("INSERT INTO compra VALUES(null,'".$orden."','".$data['idProducto'][$i]."','".$data['cantidad'][$i]."','".$data['diaEntrega']."','".$data['horaEntrega']."','0','".$data['cliente']."','".$data['telefono']."','0','0','0','0','0','0','0','marias','0','0','0','".$data['fecha_registro']. "','" . $data['confirmacionDomicilio'] . "',null,'0','" . $data['file'] ."')");
    ...
    public function saveShopping4($data){
		...
		$query = $this->db->query("INSERT INTO compra VALUES(null,'" . $orden . "','" . $data['idProducto'] . "','" . $data['cantidad'] . "','" . $data['diaEntrega'] . "','" . $data['horaEntrega'] . "','0','" . $data['cliente'] . "','" . $data['telefono'] . "','0','0','0','0','0','0','0','marias','0','0','0','" . $data['fecha_registro'] . "','" . $data['confirmacionDomicilio'] . "',null,'0','" . $data['file'] ."')");
    ...
    public function getProductResumeCustomer($id){
        ...
        $query = $this->db->query("SELECT compra.numeroOrden,productos.nombre,productos.precio,cantidad,(productos.precio*cantidad)AS subtotal,imagenes.imagen,horaEntrega,horaEntregaEspecial,costoEnvio,productos.modelo,tipoEntrega,diaEntrega,statusEnvio, baucher, compra.confirmarDomicilio  FROM compra INNER JOIN productos ON compra.producto = productos.id_producto INNER JOIN imagenes ON productos.id_producto = imagenes.producto WHERE compra.numeroOrden = '".$id."' GROUP BY modelo");
    ...
    public function getProductResume($id){
        ...
        $query = $this->db->query("	SELECT 	compra.numeroOrden,productos.nombre,productos.precio,cantidad,(productos.precio*cantidad)AS subtotal,
											imagenes.imagen,horaEntrega,horaEntregaEspecial,costoEnvio,productos.modelo,tipoEntrega,diaEntrega,statusEnvio,
											baucher,pagos.statusPago,compra.confirmarDomicilio,compra.geolocalizacion 
									FROM compra 
...
WHERE numeroOrden = '".$data['noOrden']."'");
    ...
    public function updatePayment($dni){
        ...
        //$this->db->query("UPDATE compra SET statusPago='1',statusEntrega='1',baucher='payPaypal.jpg' where numeroOrden ='".$dni."';");
			/*$this->db->query("UPDATE compra com 
						INNER JOIN pagos  pag
						on com.numeroOrden=pag.numeroOrden
						SET com.statusEnvio='1', com.baucher='payPaypal.jpg'
						,  pag.statusPago='1' WHERE com.numeroOrden ='".$dni."';");*/
			$this->db->query("UPDATE compra com 
						INNER JOIN pagos  pag
						on com.numeroOrden=pag.numeroOrden
						SET com.statusEnvio='1'
						,  pag.statusPago='1' WHERE com.numeroOrden ='".$dni."';");
