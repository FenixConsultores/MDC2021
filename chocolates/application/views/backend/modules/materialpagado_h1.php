...
<i class="fa fa-print"></i> Imprimir</a>
  ...
  <li class="nav-item">
    <a class="nav-link active" href="materialpagado_h1">A domicilio</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="materialpagado_h1marias">En Marias</a>
  </li>
</ul>
 ...
 <div class="row">
                <div class="col-4">
                    <div class="form-group">
						...
						if (isset($_GET["DateIn"]) ) {
    						...
    						$minDateIn = $_GET["DateIn"];
						}
						else{
							$minDateIn=date("Y-m-d"); 
						}
						if (isset($_GET["DateFn"]) ) {
						...
						?>
                            <div class="input-group">
                                <input type="text" name="" class="form-control" id="minDateIn" value="<?= $minDateIn;?>" >
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="" class="form-control" id="minDateFin" value="<?= $DateFn;?>">
                            <div class="input-group-append"> <span class="input-group-text"><span class="far fa-calendar-alt"></span></span>
                            </div>
                        </div>
                    </div>
		...
		<div class="content-products row" >
			...
			<?php 	
				...
				for ($i=0; $i <count($material) ; $i++) {
					if(( $material[$i]['diaEntrega'] >= $minDateIn) && ( $material[$i]['diaEntrega'] <= $DateFn)){
