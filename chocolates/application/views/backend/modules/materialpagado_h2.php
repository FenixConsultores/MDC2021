...
<i class="fa fa-print"></i> Imprimir</a>
  ...
  <li class="nav-item">
    <a class="nav-link active" href="materialpagado_h2">A domicilio</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="materialpagado_h2marias">En Marias</a>
  </li>
</ul>
 ...
 <div class="row">
                <div class="col-4">
                    <div class="form-group">
                       ...
                       <?php
						if (isset($_GET["DateIn2"]) ) {
   
    						$DateIn2 = $_GET["DateIn2"];
						}
						else{
							$DateIn2=date("Y-m-d"); 
						}
						if (isset($_GET["DateFn2"]) ) {
   
    						$DateFn2 = $_GET["DateFn2"];
						}
						else{
							$DateFn2=date("Y-m-d"); 
						}
						...
						?>
                            <div class="input-group">
                                <input type="text" name="" class="form-control" id="DateIn2" value="<?= $DateIn2;?>">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="" class="form-control" id="DateFn2" value="<?= $DateFn2;?>">
                            <div class="input-group-append"> <span class="input-group-text"><span class="far fa-calendar-alt"></span></span>
                            </div>
                        </div>
                    </div>
		...
		<div class="content-products row" >
			...
			<?php 	
				...
				for ($i=0; $i <count($material) ; $i++) {
					if(( $material[$i]['diaEntrega'] >= $DateIn2) && ( $material[$i]['diaEntrega'] <= $DateFn2)){
