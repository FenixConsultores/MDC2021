...
<i class="fa fa-print"></i> Imprimir</a>
  ...
  <li class="nav-item">
    <a class="nav-link active" href="materialpagado_h3">A domicilio</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="materialpagado_h3marias">En Marias</a>
  </li>
</ul>
 ...
 <div class="row">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <?php
						if (isset($_GET["DateIn3"]) ) {
   
    						$DateIn3 = $_GET["DateIn3"];
						}
						else{
							$DateIn3=date("Y-m-d"); 
						}
						if (isset($_GET["DateFn3"]) ) {
   
    						$DateFn3 = $_GET["DateFn3"];
						}
						else{
							$DateFn3=date("Y-m-d"); 
						}
						...
						?>
                            <div class="input-group">
                                <input type="text" name="" class="form-control" id="DateIn3" value="<?= $DateIn3;?>">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="" class="form-control" id="DateFn3" value="<?= $DateFn3;?>">
                            <div class="input-group-append"> <span class="input-group-text"><span class="far fa-calendar-alt"></span></span>
                            </div>
                        </div>
                    </div>
		...
		<div class="content-products row" >
			...
			<?php 	
				...
				for ($i=0; $i <count($material) ; $i++) {
					if(( $material[$i]['diaEntrega'] >= $DateIn3) && ( $material[$i]['diaEntrega'] <= $DateFn3)){
