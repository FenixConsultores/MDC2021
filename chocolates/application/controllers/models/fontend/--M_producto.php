...
class M_producto extends CI_Model {
    ...
    */
    ...
    public function saveShopping3($data){
		...
		$query = $this->db->query("INSERT INTO compra VALUES(null,'" . $orden . "','" . $data['idProducto'] . "','" . $data['cantidad'] . "','" . $data['diaEntrega'] . "','" . $data['horaEntrega'] . "','" . $data['hourEntregaSpecial'] . "','" . $data['cliente'] . "','" . $data['telefono'] . "','" . $data['personaEntregar'] . "','" . $data['telefonoPersonaEntrega'] . "','" . $data['nota'] . "','" . $data['direccion'] . "','" . $data['costoEnvio'] . "','" . $data['geolocalizacion'] . "','" . $data['descripcionDomicilio'] . "','domicilio','0','0','0','" . $data['fecha_registro'] . "','" . $data['confirmacionDomicilio'] . "','" . $data['detalleExteriorDomicilio'] . "',null,null)");
    ...
    public function saveShopping4($data){
		...
		$query = $this->db->query("INSERT INTO compra VALUES(null,'" . $orden . "','" . $data['idProducto'] . "','" . $data['cantidad'] . "','" . $data['diaEntrega'] . "','" . $data['horaEntrega'] . "','0','" . $data['cliente'] . "','" . $data['telefono'] . "','0','0','0','0','0','0','0','marias','0','0','0','" . $data['fecha_registro'] . "','" . $data['confirmacionDomicilio'] . "','" . $data['detalleExteriorDomicilio'] . "',null,null)");
