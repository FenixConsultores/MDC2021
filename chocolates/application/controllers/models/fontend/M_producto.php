    ...
    */
    ...
    public function saveShopping1($data){
        ...
        for ($i=0; $i <count($data['idProducto']) ; $i++) {
			...
			$this->db->query("INSERT INTO compra VALUES(null,'" . $orden . "','" . $data['idProducto'][$i] . "','" . $data['cantidad'][$i] . "','" . $data['diaEntrega'] . "','" . $data['horaEntrega'] . "','" . $data['hourEntregaSpecial'] . "','" . $data['cliente'] . "','" . $data['telefono'] . "','" . $data['personaEntregar'] . "','" . $data['telefonoPersonaEntrega'] . "','" . $data['nota'] . "','" . $data['direccion'] . "','0','" . $data['geolocalizacion'] . "','" . $data['descripcionDomicilio'] . "','domicilio','0','0','0','" . $data['fecha_registro'] . "','" . $data['confirmacionDomicilio'] . "','" . $data['detalleExteriorDomicilio'] . "','0')");

        }

		$this->db->query("INSERT INTO compra VALUES(null,'" . $orden . "','" . $dni . "','" . $cantidad . "','" . $data['diaEntrega'] . "','" . $data['horaEntrega'] . "','" . $data['hourEntregaSpecial'] . "','" . $data['cliente'] . "','" . $data['telefono'] . "','" . $data['personaEntregar'] . "','" . $data['telefonoPersonaEntrega'] . "','" . $data['nota'] . "','" . $data['direccion'] . "','" . $data['costoEnvio'] . "','" . $data['geolocalizacion'] . "','" . $data['descripcionDomicilio'] . "','domicilio','0','0','0','" . $data['fecha_registro'] . "','" . $data['confirmacionDomicilio'] . "','" . $data['detalleExteriorDomicilio'] . "','0')");
    ...
    public function saveShopping2($data){
        ...
        for ($i=0; $i <count($data['idProducto']) ; $i++) { 
            ...
            $this->db->query("INSERT INTO compra VALUES(null,'".$orden."','".$data['idProducto'][$i]."','".$data['cantidad'][$i]."','".$data['diaEntrega']."','".$data['horaEntrega']."','0','".$data['cliente']."','".$data['telefono']."','0','0','0','0','0','0','0','marias','0','0','0','".$data['fecha_registro']. "','" . $data['confirmacionDomicilio'] . "',null,'0')");
    ...
    public function saveShopping4($data){
		...
		$query = $this->db->query("INSERT INTO compra VALUES(null,'" . $orden . "','" . $data['idProducto'] . "','" . $data['cantidad'] . "','" . $data['diaEntrega'] . "','" . $data['horaEntrega'] . "','0','" . $data['cliente'] . "','" . $data['telefono'] . "','0','0','0','0','0','0','0','marias','0','0','0','" . $data['fecha_registro'] . "','" . $data['confirmacionDomicilio'] . "',null,'0')");
