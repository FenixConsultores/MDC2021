...
/*******************************INVENTARIO******************************************************/
    ...
    public function m_addInventario($data){
        ...
        /*$query =  $this->db->query("INSERT  INTO 	inventario 	(descripcion,cantidad_fisica,maximo,minimo,id_udm,ingrediente) 
...
FROM 
	...
	FROM compra com, 
			productos prod
	WHERE 	com.producto =prod.id_producto 
			AND com.statusRegistro <3 and com.diaEntrega  > DATE_ADD(CURDATE(), INTERVAL -1 DAY) and com.baucher is not null and com.baucher <> '0'
			GROUP BY com.producto)inicio 
LEFT JOIN ingrediente_producto inprod
		ON inicio.producto=inprod.id_producto
LEFT JOIN inventario inv
